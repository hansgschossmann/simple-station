...
namespace SimpleStation
{
    ...
    public class Program
    {
        ...
        public async static Task MainAsync(string[] args)
        {
            ...
            Mono.Options.OptionSet options = new Mono.Options.OptionSet {
                ...
                { "st|stationtype=", $"sets the station type and default port\nDefault: {stationType[0]}\nAllowed: {stationType[0]}, {stationType[1]}, {stationType[2]}", (string s) => {
                        ...
                        {
                            throw new OptionException("The stationtype must be one of: assembly, test, packaging", "stationtype");
                        }
                    }
                },
                ...
                { "to|trustowncert", $"the application certificate is put into the trusted certificate store automatically.\nDefault: {TrustMyself}", t => TrustMyself = t != null },
            ...
            Logger.Information($"{Assembly.GetEntryAssembly().GetName().Name} V{ThisAssembly.AssemblyVersion}");
        ...
        private static async Task ConsoleServerAsync()
        {
            ...
            OpcApplicationConfiguration stationOpcApplicationConfiguration = new OpcApplicationConfiguration(_stationType);
        ...
        private static void Usage(Mono.Options.OptionSet options)
        {
            // show usage
            Logger.Information("");
            Logger.Information($"{Assembly.GetEntryAssembly().GetName().Name} V{ThisAssembly.AssemblyVersion} (Informational Version: {ThisAssembly.AssemblyInformationalVersion})");
            Logger.Information("Usage: {0}.exe [<options>]", Assembly.GetEntryAssembly().GetName().Name);
            Logger.Information("");
            Logger.Information("Simple station for productionline simulation");
        ...
        private static string _stationType = "assembly";
    }
}
