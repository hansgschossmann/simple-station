...
#pragma warning restore CA1308 // Normalize strings to uppercase
        ...
        public static string ApplicationName { get; set; } = "simple-station";
        public static string ApplicationUri => $"urn:{Hostname}:{ApplicationName}:hansgschossmann:";
        public static string ProductUri => "https://github.com/hansgschossmann/simple-station.git";
        ...
        /// </summary>
        public OpcApplicationConfiguration(string stationType)
        {
            _stationType = stationType;
            ApplicationName = _stationType + "station";
        }
        ...
        private static void LoggerOpcUaTraceHandler(object sender, TraceEventArgs e)
        {
            ...
            if (e.Arguments == null)
            {
                message = string.Format(CultureInfo.InvariantCulture, e.Format).Trim();
            }
            else
            {
